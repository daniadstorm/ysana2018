        ...
        <div class="container mt-3 mb-5">
            <div id="accordion">
                <div class="card categoria">
                    <div class="card-header" id="acor_head1" data-toggle="collapse" data-target="#acordeon_eficaps" aria-expanded="false" aria-controls="acordeon_eficaps">
                        <p>
            ...
            <div class="card categoria">
                <div class="card-header" id="acor_head2" data-toggle="collapse" data-target="#acordeon_mujer" aria-expanded="false" aria-controls="acordeon_mujer">
                    <p>
            ...
            <div class="card categoria">
                <div class="card-header" id="acor_head3" data-toggle="collapse" data-target="#acordeon_autocuidado" aria-expanded="false" aria-controls="acordeon_autocuidado">
                    <p>
            ...
            <div class="card categoria">
                <div class="card-header" id="acor_head4" data-toggle="collapse" data-target="#acordeon_senior" aria-expanded="false"
                    aria-controls="acordeon_senior">
                    <p>
            ...
            <div class="card categoria">
                <div class="card-header" id="acor_head5" data-toggle="collapse" data-target="#acordeon_respira" aria-expanded="false"
                    aria-controls="acordeon_respira">
                    <p>
            ...
            <div class="card categoria">
                <div class="card-header" id="acor_head6" data-toggle="collapse" data-target="#acordeon_infantil" aria-expanded="false"
                    aria-controls="acordeon_infantil">
                    <p>
