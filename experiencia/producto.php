...
while(!$encontrado && $cont_prod<count($productos_ysana_experiencia)){
    //echo '<h1>'.$productos_ysana_experiencia[$cont_prod]['nombre_categoria'].'</h1>';
    while(!$encontrado && $cont_prod_cat<count($productos_ysana_experiencia[$cont_prod]['productos_categoria'])){
        if($id_producto==$productos_ysana_experiencia[$cont_prod]['productos_categoria'][$cont_prod_cat]['url-seo']){
            $encontrado=true;
            $nombre=$productos_ysana_experiencia[$cont_prod]['productos_categoria'][$cont_prod_cat]['nombre'];
            $nombre_categoria=$productos_ysana_experiencia[$cont_prod]['nombre_categoria'];
            $usos_prod=$productos_ysana_experiencia[$cont_prod]['productos_categoria'][$cont_prod_cat]['usos'];
            $descripcion=$productos_ysana_experiencia[$cont_prod]['productos_categoria'][$cont_prod_cat]['descripcion'];
            $stock=$productos_ysana_experiencia[$cont_prod]['productos_categoria'][$cont_prod_cat]['stock'];
            $precio=$productos_ysana_experiencia[$cont_prod]['productos_categoria'][$cont_prod_cat]['precio'];
            $info_producto=$productos_ysana_experiencia[$cont_prod]['productos_categoria'][$cont_prod_cat]['informacion'];
        }
        $cont_prod_cat++;
    }
    $cont_prod_cat=0;
